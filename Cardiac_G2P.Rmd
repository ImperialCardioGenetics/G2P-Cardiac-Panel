...
```{r read_g2p, eval=FALSE, message=FALSE, warning=FALSE, include=FALSE}

g2p_raw <- read_excel("master.xlsx",col_types = "text") 

g2p_raw |> write_csv("Cardiac_G2P.csv",col_names = T,quote = "all")
...
g2p <- read_csv("Cardiac_G2P.csv",col_names = T, col_types = cols(.default = "c"))
